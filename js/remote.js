...
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;R7("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",Q7,c)}},bAa=function(){if(T7("CriOS")){var a=window.__gCrWeb&&window.__gCrWeb.message&&window.__gCrWeb.message.invokeOnHost;
if(a){aAa();a({command:"cast.sender.init"});return}}if(!window.chrome||T7("Edge"))Q7();else if(aAa(),T7("Android")&&T7("Chrome/")&&window.navigator.presentation){a="";var b=g.Oh();55<=b?a="55":50<=b&&(a="50");R7("//www.gstatic.com/eureka/clank"+a+g.Dsa,Q7)}else S7(0)},cAa=function(a){g.TG[a]&&(a=g.TG[a],(0,g.G)(a,function(a){g.RG[a]&&delete g.RG[a]}),a.length=0)},dAa=function(a){var b=g.QG();
...
g.Wc(a,"https://www.gstatic.com/cv/js/sender/v1/cast_sender.js");a=a.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+g.Za(a)},hAa=function(a,b){var c=g.Bd("SCRIPT");
...
g.Xc(c,g.ae("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"));var d=window.document.getElementsByTagName("head")[0]||window.document.body;d.insertBefore(c,d.firstChild);return c},iAa=function(){var a=gAa(),b=window.document.getElementById(a),c=b&&g.fG(b,"loaded");
...
c(!1))},d?window.spf?window.spf.script.load("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js","",void 0):iAa():bAa())):U7("Cannot initialize because not running Chrome")},e8=function(a,b){g.HG.call(this);
